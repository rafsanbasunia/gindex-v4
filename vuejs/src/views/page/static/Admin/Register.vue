            ...
            <div class="field">
              <div class="control">
                <div class="b-checkbox is-warning is-circular is-inline">
                  ...
                  <label for="terms">
                    <span class="content has-text-white">  I Accept and Read the <a class="has-text-warning" href="https://raw.githubusercontent.com/rafsanbasunia/gindex-v4/CONTRIBUTING.md" target="_blank">Community Guidelines</a></span>
                  </label>
                </div>
              </div>
            </div>
            <div class="field">
              <div class="control">
                <div class="b-checkbox is-warning is-circular is-inline">
                  ...
                  <label for="code">
                    <span class="content has-text-white">  I Accept and Read the <a class="has-text-warning" href="https://github.com/rafsanbasunia/gindex-v4/Terms_and_Conditions.md" target="_blank">Terms and Conditions</a></span>
                  </label>
                </div>
              </div>
            </div>
